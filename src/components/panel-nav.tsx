...
import { LogoMark, IconChat, IconFunnel, IconCalendar, IconBroadcast, IconTarget, IconImage, IconFolder } from "./icons";
...
type Key = "painel" | "pipeline" | "agenda" | "anuncios" | "criativos" | "projetos" | "central" | "clientes" | "acesso";
